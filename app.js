...
║   ╚════════════╝ ╚═══════════╝  ╚═╝      ╚═╝   ╚═══════╝     ║
╚══════════════════════════════════════════════════════════════╝
               ${chalk.italic.gray(`v${stats.version} - by Rtrokil`)}
`));
...
process.on('exit', () => { logger.info('Closing Zero... If you liked this project, make sure to leave it a star on github: https://github.com/Rtrokil/Zero-Gen-Public- ! <3'); checkForUpdates(); });
